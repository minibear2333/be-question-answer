...
function dwqa_question_registration_setting_display() {
	...
	<label for="dwqa_option_answer_registation"><span class="description"><?php _e( 'Login required. No anonymous post allowed','be-question-answer' ); ?></span></label></p>
	<?php
}
	...
	<p>
		<?php
			wp_dropdown_pages( array(
				...
				'show_option_none'  => __( 'Select Archive Question Page','be-question-answer' ),
				'option_none_value' => 0,
				'selected'          => $archive_question_page,
			) );
		?><br><span class="description"><?php _e( 'A page where displays all questions. The <code>[dwqa-list-questions]</code> short code must be on this page.','be-question-answer' ) ?></span>
	</p>
	<?php
}
	...
	<p>
		<?php
			wp_dropdown_pages( array(
				...
				'show_option_none'  => __( 'Select Submit Question Page','be-question-answer' ),
				'option_none_value' => 0,
				'selected'          => $submit_question_page,
			) );
		?><br>
		<span class="description"><?php _e( 'A page where users can submit questions. The <code>[dwqa-submit-question-form]</code> short code must be on this page.','be-question-answer' ) ?></span>
	</p>
	<?php
}
	...
	<p>
		<?php
			wp_dropdown_pages( array(
				...
				'show_option_none'  => __( 'Select 404 DWQA Page','be-question-answer' ),
				'option_none_value' => 0,
				'selected'          => $submit_question_page,
			) );
		?>
		<span class="description"><?php _e( 'This page will be redirected when users without authority click on a private question. You can customize the message of this page in.If not, a default 404 page will be used.','be-question-answer' ) ?></span>
	</p>
	<?php
}
...
function dwqa_subscrible_email_logo_display(){
	...
	?>
	<div class="uploader">
		<p><input type="text" name="dwqa_subscrible_email_logo" id="dwqa_subscrible_email_logo" class="regular-text" value="<?php echo  get_option( 'dwqa_subscrible_email_logo' ); ?>" />&nbsp;<input type="button" class="button" name="dwqa_subscrible_email_logo_button" id="dwqa_subscrible_email_logo_button" value="<?php _e( 'Upload','be-question-answer' ) ?>" /></br><span class="description">&nbsp;<?php _e( 'Upload or choose a logo to be displayed at the top of the email.','be-question-answer' ) ?></span></p>
	</div>
...
function dwqa_subscrible_enable_new_question_notification(){
	echo '<th>'.__( 'Enable?','be-question-answer' ).'</th><td><input type="checkbox" value="1" '.checked( 1, get_option( 'dwqa_subscrible_enable_new_question_notification', 1 ), false ).' name="dwqa_subscrible_enable_new_question_notification" id="dwqa_subscrible_enable_new_question_notification" ><span class="description">'.__( 'Enable notification for new question.', 'be-question-answer' ).'</span></td>';
}
// New Question - Enable Notification

function dwqa_subscrible_new_question_email_subject_display(){ 
	echo '<th>'.__( 'Email subject','be-question-answer' ).'</th><td><input type="text" id="dwqa_subscrible_new_question_email_subject" name="dwqa_subscrible_new_question_email_subject" value="'.get_option( 'dwqa_subscrible_new_question_email_subject' ).'" class="regular-text" /></span></td>';
}
// New Question - Email subject

function dwqa_subscrible_new_question_email_display(){
	echo '<th for="dwqa_subscrible_new_question_email">'.__( 'Email Content','be-question-answer' ).'</th>';
	echo '<td>';
...
function dwqa_subscrible_enable_new_answer_notification(){
	echo '<th>'.__( 'Enable?','be-question-answer' ).'</th><td><input type="checkbox" value="1" '.checked( 1, get_option( 'dwqa_subscrible_enable_new_answer_notification', 1 ), false ).' name="dwqa_subscrible_enable_new_answer_notification" id="dwqa_subscrible_enable_new_answer_notification" ><span class="description">'.__( 'Enable notification for new answer.', 'be-question-answer' ).'</span></td>';
}
// New Answer - Enable Notification

function dwqa_subscrible_new_answer_email_subject_display(){ 
	echo '<th>'.__( 'Email subject','be-question-answer' ).'</th><td><input type="text" id="dwqa_subscrible_new_answer_email_subject" name="dwqa_subscrible_new_answer_email_subject" value="'.get_option( 'dwqa_subscrible_new_answer_email_subject' ).'" class="regular-text" /></span></td>';
}
// New Answer - Email Subject

function dwqa_subscrible_new_answer_email_display(){
	echo '<th>'.__( 'Email Content','be-question-answer' ).'</th>';
	echo '<td>';
...
function dwqa_subscrible_enable_new_answer_followers_notification(){
	echo '<th>'.__( 'Enable?','be-question-answer' ).'</th><td><input type="checkbox" value="1" '.checked( 1, get_option( 'dwqa_subscrible_enable_new_answer_followers_notification', 1 ), false ).' name="dwqa_subscrible_enable_new_answer_followers_notification" id="dwqa_subscrible_enable_new_answer_followers_notification" ><span class="description">'.__( 'Enable notification for new answer ( to Followers ).', 'be-question-answer' ).'</span></td>';
}
// New Answer - Follow - Enable Notification

function dwqa_subscrible_new_answer_followers_email_subject_display(){ 
	echo '<th>'.__( 'Email subject','be-question-answer' ).'</th><td><input type="text" id="dwqa_subscrible_new_answer_followers_email_subject" name="dwqa_subscrible_new_answer_followers_email_subject" value="'.get_option( 'dwqa_subscrible_new_answer_followers_email_subject' ).'" class="regular-text" /></span></td>';
}
...
function dwqa_subscrible_enable_new_comment_question_notification(){
	echo '<th>'.__( 'Enable?','be-question-answer' ).'</th><td><input type="checkbox" '.checked( 1, get_option( 'dwqa_subscrible_enable_new_comment_question_notification', 1 ), false ).' value="1" name="dwqa_subscrible_enable_new_comment_question_notification" id="dwqa_subscrible_enable_new_comment_question_notification" ><span class="description">'.__( 'Enable notification for new comment of question.', 'be-question-answer' ).'</span></td>';
}
// New Comment - Question - Enable Notification

function dwqa_subscrible_new_comment_question_email_subject_display(){ 
	echo '<th>'.__( 'Email subject','be-question-answer' ).'</th><td><input type="text" id="dwqa_subscrible_new_comment_question_email_subject" name="dwqa_subscrible_new_comment_question_email_subject" value="'.get_option( 'dwqa_subscrible_new_comment_question_email_subject' ).'" class="regular-text" /></td>';
}
// New Comment - Question - Email subject

function dwqa_subscrible_new_comment_question_email_display(){
	echo '<th>'.__( 'Email Content','be-question-answer' ).'</th><td>';
...
function dwqa_subscrible_enable_new_comment_question_followers_notification(){
	echo '<th>'.__( 'Enable?','be-question-answer' ).'</th><td><input type="checkbox" '.checked( 1, get_option( 'dwqa_subscrible_enable_new_comment_question_followers_notify', 1 ), false ).' value="1" name="dwqa_subscrible_enable_new_comment_question_followers_notify" id="dwqa_subscrible_enable_new_comment_question_followers_notify" ><span class="description">'.__( 'Enable notification for new comment of question.', 'be-question-answer' ).'</span></td>';
}
...
function dwqa_subscrible_new_comment_question_followers_email_subject_display(){ 
	echo '<th>'.__( 'Email subject','be-question-answer' ).'</th><td><input type="text" id="dwqa_subscrible_new_comment_question_followers_email_subject" name="dwqa_subscrible_new_comment_question_followers_email_subject" value="'.get_option( 'dwqa_subscrible_new_comment_question_followers_email_subject' ).'" class="widefat" /></td>';
}
...
function dwqa_subscrible_enable_new_comment_answer_notification(){
	echo '<th>'.__( 'Enable?','be-question-answer' ).'</th><td><input type="checkbox" '.checked( 1, get_option( 'dwqa_subscrible_enable_new_comment_answer_notification', 1 ), false ).' value="1" name="dwqa_subscrible_enable_new_comment_answer_notification" id="dwqa_subscrible_enable_new_comment_answer_notification" ><span class="description">'.__( 'Enable notification for new comment of answer.', 'be-question-answer' ).'</span></td>';
}
// New Comment - Answer - Enable Notification

function dwqa_subscrible_new_comment_answer_email_subject_display(){ 
	echo '<th>'.__( 'Email subject','be-question-answer' ).'</th><td><input type="text" id="dwqa_subscrible_new_comment_answer_email_subject" name="dwqa_subscrible_new_comment_answer_email_subject" value="'.get_option( 'dwqa_subscrible_new_comment_answer_email_subject' ).'" class="regular-text" /></td>';
}
...
function dwqa_subscrible_enable_new_comment_answer_followers_notification(){
	echo '<th>'.__( 'Enable?','be-question-answer' ).'</th><td><input type="checkbox" '.checked( 1, get_option( 'dwqa_subscrible_enable_new_comment_answer_followers_notification', 1 ), false ).' value="1" name="dwqa_subscrible_enable_new_comment_answer_followers_notification" id="dwqa_subscrible_enable_new_comment_answer_followers_notification" ><span class="description">'.__( 'Enable notification for new comment of answer.', 'be-question-answer' ).'</span></td>';
}
// New Comment - Answer - Follow - Enable Notification

function dwqa_subscrible_new_comment_answer_followers_email_subject_display(){ 
	echo '<th>'.__( 'Email subject','be-question-answer' ).'</th><td><input type="text" id="dwqa_subscrible_new_comment_answer_followers_email_subject" name="dwqa_subscrible_new_comment_answer_followers_email_subject" value="'.get_option( 'dwqa_subscrible_new_comment_answer_followers_email_subject' ).'" class="regular-text" /></td>';
}
...
function dwqa_permission_display(){
	...
	<h3><?php _e( 'Questions','be-question-answer' ) ?></h3>
	<table class="table widefat dwqa-permission-settings">
		<thead>
			<tr>
				<th width="20%"></th>
				<th><?php _e( 'Read','be-question-answer' ) ?></th>
				<th><?php _e( 'Post','be-question-answer' ) ?></th>
				<th><?php _e( 'Edit','be-question-answer' ) ?></th>
				<th><?php _e( 'Delete','be-question-answer' ) ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<?php endforeach; ?>
			<tr class="group available">
				<td><?php _e( 'Anonymous','be-question-answer' ) ?></td>
	...
	<p class="reset-button-container align-right" style="text-align:right">
		<button data-type="question" class="button reset-permission" name="dwqa-permission-reset" value="question"><?php _e( 'Reset Default', 'be-question-answer' ); ?></button>
	</p>
	<h3><?php _e( 'Answers', 'be-question-answer' ); ?></h3>
	<table class="table widefat dwqa-permission-settings">
		<thead>
			<tr>
				<th width="20%"></th>
	...
	<p class="reset-button-container align-right" style="text-align:right">
		<button data-type="answer" class="button reset-permission" name="dwqa-permission-reset" value="answer"><?php _e( 'Reset Default', 'be-question-answer' ); ?></button>
	</p>
	<h3><?php _e( 'Comments','be-question-answer' ) ?></h3>
	<table class="table widefat dwqa-permission-settings">
		<thead>
			<tr>
				<th width="20%"></th>
	...
	<p class="reset-button-container align-right" style="text-align:right">
		<button data-type="comment" class="button reset-permission" name="dwqa-permission-reset" value="comment"><?php _e( 'Reset Default', 'be-question-answer' ); ?></button>
	</p>
	<?php
}
...
function dwqa_captcha_select_type_display() {
	...
	$types = apply_filters( 'dwqa_captcha_type', array( 'default' => __( 'Default', 'be-question-answer' ) ) );
	$total = count( $types );
...
function dwqa_posts_per_page_display(){
	...
	echo '<p><input type="text" name="dwqa_options[posts-per-page]" class="small-text" value="'.$posts_per_page.'" > <span class="description">'.__( 'questions.','be-question-answer' ).'</span></p>';
}
...
function dwqa_answer_per_page_display() {
	...
	echo '<p><input id="dwqa_setting_answers_per_page" type="text" name="dwqa_options[answer-per-page]" class="small-text" value="'.$posts_per_page.'" > <span class="description">'.__( 'answers.','be-question-answer' ).'</span></p>';
}

function dwqa_allow_anonymous_vote() {
	global $dwqa_general_settings;
	
	echo '<p><label for="dwqa_options_allow_anonymous_vote"><input type="checkbox" name="dwqa_options[allow-anonymous-vote]"  id="dwqa_options_allow_anonymous_vote" value="1" '.checked( 1, (isset($dwqa_general_settings['allow-anonymous-vote'] ) ? $dwqa_general_settings['allow-anonymous-vote'] : false ) , false ) .'><span class="description">'.__( 'Allow anonymous vote.', 'be-question-answer' ).'</span></label></p>';
}

function dwqa_use_auto_closure() {
	global $dwqa_general_settings;
	
	echo '<p><label for="dwqa_options_use_auto_closure"><input type="checkbox" name="dwqa_options[use-auto-closure]"  id="dwqa_options_use_auto_closure" value="1" '.checked( 1, (isset($dwqa_general_settings['use-auto-closure'] ) ? $dwqa_general_settings['use-auto-closure'] : false ) , false ) .'><span class="description">'.__( 'Enable Auto Closure', 'be-question-answer' ).'</span></label></p>';
}
function dwqa_number_day_auto_closure() {
	...
	echo '<p><input id="dwqa_setting_number_day_auto_closure" type="text" name="dwqa_options[number-day-auto-closure]" class="medium-text" value="'.$number_day_auto_closure.'" > <span class="description">'.__( 'Days.(greater 0)','be-question-answer' ).'</span></p>';
}
	...
	?>
		<p><label for="dwqa_single_question_template">
				<select name="dwqa_options[single-template]" id="dwqa_single_question_template">
					<option <?php selected( $selected, -1 ); ?> value="-1"><?php _e( 'Select template for Single Quesiton page','be-question-answer' ) ?></option>
					...
					<?php endforeach; ?>
				</select> <span class="description"><?php _e( 'By default, your single.php template file will be used if you do not choose any template', 'be-question-answer' ) ?></span>
			</label>
		</p>
	<?php
...
class DWQA_Settings {
	...
	public function admin_menu(){
		...
		$dwqa_setting_page = add_submenu_page( 'edit.php?post_type=dwqa-question', __( 'Plugin Settings','be-question-answer' ), __( 'Settings','be-question-answer' ), 'manage_options', 'dwqa-settings', array( $this, 'settings_display' )  );
	}   
	...
	public function email_tabs() {
		...
		?>
		<ul class="subsubsub">
			<li class="<?php echo $section == 'general' ? 'active' : '' ?>"><a href="<?php echo add_query_arg( 'section', 'general', admin_url( 'edit.php?post_type=dwqa-question&page=dwqa-settings&tab=email' ) ) ?>"><?php _e( 'Email Settings', 'be-question-answer' ) ?></a> &#124; </li>
			<li class="<?php echo $section == 'new-question' ? 'active' : '' ?>"><a href="<?php echo add_query_arg( 'section', 'new-question', admin_url( 'edit.php?post_type=dwqa-question&page=dwqa-settings&tab=email' ) ) ?>"><?php _e( 'New Question Notifications', 'be-question-answer' ) ?></a> &#124; </li>
			<li class="<?php echo $section == 'new-answer' ? 'active' : '' ?>"><a href="<?php echo add_query_arg( 'section', 'new-answer', admin_url( 'edit.php?post_type=dwqa-question&page=dwqa-settings&tab=email' ) ) ?>"><?php _e( 'New Answer Notifications', 'be-question-answer' ) ?></a> &#124; </li>
			<li class="<?php echo $section == 'new-comment' ? 'active' : '' ?>"><a href="<?php echo add_query_arg( 'section', 'new-comment', admin_url( 'edit.php?post_type=dwqa-question&page=dwqa-settings&tab=email' ) ) ?>"><?php _e( 'New Comment Notifications', 'be-question-answer' ) ?></a></li>
		</ul>
		<div class="clear"></div>
		<?php
		return ob_get_clean();
	...
	public function register_settings(){
		...
		add_settings_section( 
			...
			__( 'Page Settings', 'be-question-answer' ),
			null, 
			'dwqa-settings' 
		);
		...
		add_settings_field( 
			...
			__( 'Question List Page', 'be-question-answer' ), 
		...
		add_settings_field( 
			...
			__( 'Ask Question Page', 'be-question-answer' ), 
		...
		// 	__( 'Single Question Template', 'be-question-answer' ), 
...
//		add_settings_section( 
//			'dwqa-time-settings', 
//			__( 'Time settings','be-question-answer' ), 
//			null, 
//			'dwqa-settings' 
//		);
//
...
//			__( 'New Question Time Frame', 'be-question-answer' ), 
...
//			__( 'Question Overdue - Time Frame', 'be-question-answer' ), 
...
//		);
		...
		add_settings_section(
			'dwqa-misc-settings',
			__( 'Question Settings', 'be-question-answer' ),
			false,
			'dwqa-settings'
		);
		...
		add_settings_field( 
			...
			__( 'Archive Page Show At Most','be-question-answer' ), 
		...
		add_settings_field( 
			...
			__( 'Before A Question Appears', 'be-question-answer' ), 
		...
		add_settings_field( 
			...
			__( 'Other Question Settings', 'be-question-answer' ), 
		...
		add_settings_section(
			...
			__( 'Answer Settings', 'be-question-answer' ),
			false,
			'dwqa-settings'
		);
		...
		add_settings_field(
			...
			__( 'Answer Listing', 'be-question-answer' ),
		...
		add_settings_section(
			'dwqa-vote-settings',
			__( 'Vote Settings', 'be-question-answer' ),
			false,
			'dwqa-settings'
		);
		...
		add_settings_field(
			...
			__( 'Allow Anonymous Vote', 'be-question-answer' ),
		...
		add_settings_section(
			...
			__( 'Auto Closure Settings', 'be-question-answer' ),
			false,
			'dwqa-settings'
		);
		...
		add_settings_field(
			...
			__( 'Use Auto Closure', 'be-question-answer' ),
		...
		add_settings_field(
			...
			__( 'Closure after', 'be-question-answer' ),
		...
		add_settings_section( 
			...
			__( 'Captcha Settings','be-question-answer' ), 
			null, 
			'dwqa-settings' 
		);
		...
		add_settings_field( 
			...
			__( 'Single Question Page', 'be-question-answer' ), 
		...
		add_settings_section( 
			...
			__( 'Permalink Settings','be-question-answer' ), 
		...
		add_settings_field( 
			...
			__( 'Question Base', 'be-question-answer' ), 
		...
		add_settings_field( 
			...
			__( 'Question Category Base', 'be-question-answer' ), 
		...
		add_settings_field( 
			...
			__( 'Question Tag Base', 'be-question-answer' ), 
		...
		//     __( 'Admin Email', 'be-question-answer' ), 
		...
		add_settings_field( 
			...
			__( 'From Email', 'be-question-answer' ), 
		...
		//     __( 'Email Logo', 'be-question-answer' ), 
		...
		add_settings_section( 
			...
			__( 'Group Permission','be-question-answer' ),
			false,
			'dwqa-permission' 
		);
	...
	public function settings_display(){
		...
		<div class="wrap">
			<h2><?php _e( 'DWQA Settings', 'be-question-answer' ) ?></h2>
			<?php settings_errors(); ?>  
			<?php $active_tab = isset( $_GET[ 'tab' ] ) ? esc_html( $_GET['tab'] ) : 'general'; ?>  
			<h2 class="nav-tab-wrapper">  
				<a href="?post_type=dwqa-question&amp;page=dwqa-settings&amp;tab=general" class="nav-tab <?php echo $active_tab == 'general' ? 'nav-tab-active' : ''; ?>"><?php _e( 'General','be-question-answer' ); ?></a>
				<a href="?post_type=dwqa-question&amp;page=dwqa-settings&amp;tab=email" class="nav-tab <?php echo $active_tab == 'email' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Emails','be-question-answer' ); ?></a>
				<a href="?post_type=dwqa-question&amp;page=dwqa-settings&amp;tab=permission" class="nav-tab <?php echo $active_tab == 'permission' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Permissions','be-question-answer' ); ?></a>
				<!-- <a href="?post_type=dwqa-question&amp;page=dwqa-settings&amp;tab=licenses" class="nav-tab <?php echo $active_tab == 'licenses' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Licenses','be-question-answer' ); ?></a> -->
			</h2>  
			...
			switch ($active_tab) {
				case 'email':
					...
					if ( $email_section === 'general' ) :
						...
						echo '<h3>'.__( 'Email settings','be-question-answer' ).'</h3>';
						echo '<table class="form-table"><tr>';
						echo '<th scope="row">'.__( 'Email Logo','be-question-answer' ).'</th><td>';
						dwqa_subscrible_email_logo_display();
						echo '</td></tr></table>';
					...
					if ( $email_section == 'new-question' ) :
						...
						echo '<h3>'.__( 'New Question Notifications (to Admin)','be-question-answer' ) . '</h3>';
					...
					if ( $email_section == 'new-answer' ) :
						...
						echo '<h3>'.__( 'New Answer Notifications (to Followers)','be-question-answer' ). '</h3>';
						echo '<table class="form-table">';
						echo '<tr>';
						...
						echo '<h3>'.__( 'New Answer Notifications (to Author)','be-question-answer' ). '</h3>';
						echo '<table class="form-table">';
						echo '<tr>';
					...
					if ( $email_section == 'new-comment' ) :
						...
						echo '<h3>'.__( 'New Comment to Question Notifications (to Followers)','be-question-answer' ). '</h3>';
						echo '<table class="form-table">';
						echo '<tr>';
						...
						echo '<h3>'.__( 'New Comment to Answer Notifications (to Followers)','be-question-answer' ). '</h3>';
						echo '<table class="form-table">';
						echo '<tr>';
					...
					submit_button( __( 'Save all changes','be-question-answer' ) );
				...
				case 'licenses':
					...
					echo '<p class="description">'.sprintf( __( 'Manage <a href="%s">DWQA Extensions</a> license keys', 'be-question-answer' ), add_query_arg( array( 'post_type' => 'dwqa-question', 'page' => 'dwqa-extensions' ), admin_url( 'edit.php' ) ) ).'</p>';
	...
	public function new_answer_forward() {
		echo '<th>'.__( 'Forward to', 'be-question-answer' ).'</th>';
	...
	public function email_cc_address_display(){
		echo '<p>'.__( 'Cc', 'be-question-answer' ).'</p>';
		$this->input_text_field( 'dwqa_subscrible_cc_address' );
	}

	public function email_bcc_address_display(){
		echo '<p>'.__( 'Bcc', 'be-question-answer' ).'</p>';
		$this->input_text_field( 'dwqa_subscrible_bcc_address' );
	}

	public function email_from_address_display(){
		$this->input_text_field( 'dwqa_subscrible_from_address', false, __( 'This address will be used as the sender of the outgoing emails.','be-question-answer' ) );
	}

	public function email_send_copy_to_admin(){
		$this->input_checkbox_field( 
			'dwqa_subscrible_send_copy_to_admin',
			__( 'Send a copy of every email to admin.','be-question-answer' )
		);
	}
	...
	public function enable_email_delay(){
		$this->input_checkbox_field( 
			'dwqa_enable_email_delay',
			__( 'Email Delay*','be-question-answer' )
		);
	}
